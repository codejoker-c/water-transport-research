    ...
    private static RoomDatabase.Callback sRoomsRoomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                userCargo[0] = new
                        user_Cargo("18199791238","123","马千里",800,"沙土石子","重庆","上海",3, 13);
                userCargo[1] = new
                        user_Cargo("19917912481","123","陈静",1000,"煤炭","镇江","上海",3, 12);

                userCargo[2] = new
                        user_Cargo("18199791090","123","吴敏",2000,"沙土石子","巫山","南京",3, 12);
                userCargo[3] = new

                        user_Cargo("18180791238","123","刘航帆",600,"煤炭","江阴","岳阳",3, 15);
                userCargo[4] = new
                        user_Cargo("19945791238","123","李和平",1100,"矿石","重庆","南通", 3, 11);
                userCargo[5] = new
                        user_Cargo("15194591238","123","程敬南",2800,"矿石","黄石","铜陵",3, 11);

                userCargo[6] = new
                        user_Cargo("1819979190","123","华勇",1200,"沙土石子","芜湖","上海",3, 12);
                userCargo[7] = new
                        user_Cargo("13299791238","123","王军",1800,"沙土石子","江陵","南京",3, 13);
                userCargo[8] = new
                        user_Cargo("18163791238","123","张中文",1250,"煤炭","黄石","镇江",3, 14);
                userCargo[9] = new
                        user_Cargo("18191291238","123","赵生明",1400,"矿石","岳阳","江阴",3, 11);
